...
import { Footer } from "@/components/ui/footer" // Import the reusable Footer
            ...
            <div className="flex flex-col items-center justify-between gap-16 lg:flex-row">
              ...
              <div className="max-w-2xl space-y-8">
                ...
                <div className="grid grid-cols-2 gap-8 pt-8">
                  <div><div className="text-3xl font-bold text-[#3FB6F6] mb-2">10K+</div><div className="text-gray-600">Active Users</div></div>
                  <div><div className="text-3xl font-bold text-[#3FB6F6] mb-2">500+</div><div className="text-gray-600">Healthcare Facilities</div></div>
                  <div><div className="text-3xl font-bold text-[#3FB6F6] mb-2">99.9%</div><div className="text-gray-600">Uptime</div></div>
                  <div><div className="text-3xl font-bold text-[#3FB6F6] mb-2">24/7</div><div className="text-gray-600">Support</div></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="testimonials" className="py-24 md:py-32 bg-white">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 group"><CardContent className="p-8"><div className="mb-6 flex">{[...Array(5)].map((_, i) => (<Star key={i} className="h-5 w-5 fill-yellow-400 text-yellow-400" />))}</div><p className="text-gray-600 mb-6 leading-relaxed">"HealthSync has transformed how I access patient medical history. The speed and accuracy have greatly improved my ability to provide better care and make more informed diagnoses."</p><div className="flex items-center"><div className="mr-4 h-14 w-14 overflow-hidden rounded-full bg-gradient-to-r from-[#3FB6F6] to-[#34D399]"><div className="flex h-full items-center justify-center text-lg font-bold text-white">DR</div></div><div><h4 className="font-bold text-gray-900">Dr. Sarah Wilson</h4><p className="text-sm text-gray-600">Pediatric Specialist</p></div></div></CardContent></Card>
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 group"><CardContent className="p-8"><div className="mb-6 flex">{[...Array(5)].map((_, i) => (<Star key={i} className="h-5 w-5 fill-yellow-400 text-yellow-400" />))}</div><p className="text-gray-600 mb-6 leading-relaxed">"Finally, no more carrying physical files! HealthSync keeps all my health data organized and easily accessible. It's made managing my healthcare so much simpler."</p><div className="flex items-center"><div className="mr-4 h-14 w-14 overflow-hidden rounded-full bg-gradient-to-r from-[#3FB6F6] to-[#34D399]"><div className="flex h-full items-center justify-center text-lg font-bold text-white">JS</div></div><div><h4 className="font-bold text-gray-900">John Smith</h4><p className="text-sm text-gray-600">Patient</p></div></div></CardContent></Card>
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 group"><CardContent className="p-8"><div className="mb-6 flex">{[...Array(5)].map((_, i) => (<Star key={i} className="h-5 w-5 fill-yellow-400 text-yellow-400" />))}</div><p className="text-gray-600 mb-6 leading-relaxed">"Implementing HealthSync has significantly improved our operational efficiency and patient satisfaction. This system has truly transformed how we manage health data."</p><div className="flex items-center"><div className="mr-4 h-14 w-14 overflow-hidden rounded-full bg-gradient-to-r from-[#3FB6F6] to-[#34D399]"><div className="flex h-full items-center justify-center text-lg font-bold text-white">MD</div></div><div><h4 className="font-bold text-gray-900">Maria Davis</h4><p className="text-sm text-gray-600">Hospital Director</p></div></div></CardContent></Card>
            </div>
          </div>
        </section>
