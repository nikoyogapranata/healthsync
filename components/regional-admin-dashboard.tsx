...
const navigationItems = [
  ...
  { id: "facilities", title: "Facility Management", icon: Building2 },
  { id: "create", title: "Account Creation", icon: UserPlus },
  { id: "analytics", title: "System Analytics", icon: BarChart2 },
        ...
        <main className="flex-1 space-y-8 p-6 bg-slate-50/50">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="facilities" className="space-y-6">
              {/* Facility Management Content remains the same, but uses the corrected card display */}
              <div className="flex justify-between items-center">
                  ...
                  >
                    ...
                    <CardContent className="space-y-3">
                      <div className="flex items-start text-sm text-gray-600">
                        <MapPin className="mr-2 h-4 w-4 mt-0.5 flex-shrink-0 text-[#3FB6F6]" />
                        <span>{`${facility.street_address || ""}, ${
                          facility.district_name || ""
                        }, ${facility.regency_name || ""}, ${
