...
import {
  ...
  Settings,
  MessageCircle,
  Calendar as LucideCalendar, // Renamed to avoid conflict with the Calendar component
  CalendarIcon,
  AlertCircle,
  Clock,
  XCircle,
...
export function AppointmentsOnline() {
  ...
  const appointmentHistory = [
    { id: 1, date: "April 12, 2023", facility: "HealthSync General Hospital", doctor: "Dr. John Smith, MD", service: "General Practice", status: "Completed" },
    { id: 2, date: "May 25, 2023", facility: "City Medical Center", doctor: "Dr. Sarah Johnson, MD", service: "Dental Care", status: "Cancelled" },
    { id: 3, date: "June 10, 2023", facility: "Community Health Clinic", doctor: "Dr. Michael Brown, MD", service: "Laboratory", status: "No Show" },
    { id: 4, date: "July 5, 2023", facility: "HealthSync General Hospital", doctor: "Dr. Emily Wilson, MD", service: "Radiology", status: "Completed" },
  ]
