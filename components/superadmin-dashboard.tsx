...
const navigationItems = [
  { title: "Overview", url: "/superadmin-dashboard", icon: Home, isActive: true },
]
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className="hover:bg-transparent">
              ...
              >
                <div className="flex aspect-square size-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#3FB6F6] to-[#34D399] text-white">
    ...
    <div className="min-h-screen flex flex-col">
      <SidebarProvider>
        ...
        <SidebarInset className="flex flex-col">
          <Header pageTitle="Super Admin Dashboard" />
              ...
              <Card className="relative overflow-hidden col-span-full flex flex-col md:flex-row items-center">
                ...
                <div className="relative z-10 p-8 text-white md:w-2/3">
                  ...
                  <p className="mt-2 text-blue-100">
                    Comprehensive system management and oversight for HealthSync platform.
                  </p>
                </div>
              </Card>
                        ...
                        <CardContent className="space-y-3">
                          ...
                          <div className="flex justify-end space-x-2 pt-4">
                            <Button
                              variant="outline"
                              size="sm"
                              className="border-[#3FB6F6] text-[#3FB6F6] hover:bg-[#3FB6F6] hover:text-white bg-transparent"
                            >
                              <Edit className="h-4 w-4" />
                            </Button>
                            <Button
                              variant="outline"
                              size="sm"
                              className="border-[#34D399] text-[#34D399] hover:bg-[#34D399] hover:text-white bg-transparent"
                            >
                    ...
                    >
                      ...
                      <CardContent>
                        <p className="text-gray-600">
                          Create a new admin user for a healthcare facility. They will receive an email verification
                          link.
                        </p>
                        <div className="mt-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              The account is created but requires email verification
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              User receives verification email and must click the link
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
